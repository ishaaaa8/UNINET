        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                if (_isLogin) {
                  if (_emailController.text == 'isha@gmail.com' &&
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Register as a Mentor'), // Added button
            ),
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
...
class MentorRegistrationPage extends StatelessWidget {
  const MentorRegistrationPage({Key? key});
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                // Add your logic here to handle mentor registration
                _submitMentorRegistration(context);
              },
              child: const Text('Submit'),
            ),
          ],
  ...
  void _submitMentorRegistration(BuildContext context) {
    
    Navigator.pop(context);
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Mentor registration submitted successfully!'),
      ),
    );
  }
}
